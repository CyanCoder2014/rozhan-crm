                                                            ...
                                                            @foreach($categories as $category)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="{{ route('eventmodule.admin.category.delete',['id' => $category->id]) }}" onclick="confirm('ایا از حذف اطمینان دارید؟')">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST"
                                  ...
                                  action="{{ route('eventmodule.admin.category.store') }}">
                                {{ csrf_field() }}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="POST"
                                      enctype="multipart/form-data"
                                      action="{{ route('eventmodule.admin.category.update',['id' => $category->id]) }}">
                                    {{ csrf_field() }}
