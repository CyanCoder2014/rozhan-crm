                                                ...
                                                <tbody>
                                                    @foreach($tickets as $ticket)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('ticketingmodule.ticket.show',['ticket' => $ticket->id]) }}">
                                                                    <button class="btn btn-success">نمایش پیام ها</button>
                                                                </a>
                                                                <a href="{{ route('ticketingmodule.ticket.delete',['ticket' => $ticket->id]) }}" onclick="confirm('ایا از حذف اطمینان دارید؟')">
